...
def create_mini_lidar_file(input_laz_path: str, output_laz_path: str, gpx_data: GPXData, distance: float = 5.0):
    ...
    transformer_to_projected = Transformer.from_crs("EPSG:4326", "EPSG:28356", always_xy=True)
