  ...
  return (
        <div className="flex flex-col justify-between h-screen">
            ...
            <main className="flex flex-col px-0 h-full">
                    ...
                    <div className="flex flex-col align-center max-w-4xl mx-auto px-6 text-center text-white gap-12">
                        ...
                        <div className="flex gap-30">
                            <div className="flex flex-col items-center gap-6">
                                ...
                                <h3 className="text-xl uppercase font-bold">Strava (Desktop)</h3>
                            </div>
                ...
                <div className="max-w-3xl px-20 text-gray-800">
                ...
                <div className="max-w-3xl px-20 text-white">
                    <div className="flex flex-row items-center gap-3">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 512 512"
                    ...
                    <ol className="list-decimal list-inside space-y-3 text-lg text-gray-300 mt-6">
                    <li>Open GNSS Logger</li>
                    <li>
                        Ensure{" "}
                    ...
                    <li>Open the &quot;Log&quot; Section</li>
                    <li>Click &quot;Start Log&quot;</li>
                    <li>Run your trail</li>
                    <li>When complete, click &quot;Stop &amp; Send&quot;</li>
                    <li>
                        Choose a mode to download your GPX data - it should be inside of a .zip
                        file with a .txt file
                    </li>
                    <li>
                        Extract the .zip file and click the button below to turn your .txt file
                        into a .gpx file
                    </li>
                    <li>
                        Your .gpx file will automatically be downloaded to your device after
                        processing
                    </li>
                    </ol>
                </div>
                ...
                <div className="max-w-3xl px-20">
                    ...
                    >
                        {/* ADD THE GROUP ELEMENT WITH TRANSFORM */}
